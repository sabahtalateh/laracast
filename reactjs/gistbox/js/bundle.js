...
var GistAddForm = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                'form',
                { className: 'form', onSubmit: this.addGist },
                React.createElement('input', { value: this.state.username, onChange: this.onChange, placeholder: 'type a username' }),
                React.createElement(
                    'button',
                    null,
                    'Fetch latest Gist'
...
var GistBox = React.createClass({
    ...
    getInitialState: function getInitialState() {
        return {
            gists: [{ username: 'alez', url: 'http://google.com' }]
        };
    },
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(_GistAddFormJs2['default'], { onAdd: this.addGist }),
